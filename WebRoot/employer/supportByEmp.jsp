        ...
        <td colspan="8" align="left" class="txlrow" height="20px">
         ...
         <td align="center" class="txlHeaderBackgroundAlternate">操作</td>
      	 ...
      	 <s:iterator value="list" var="s">
    	   	...
    	   	<a href="employer/support!supportMsg.htm?support.id=<s:property value="#t.id" />">查看</a>
   	   	 	<a href="employer/support!updateSupport.htm?support.id=<s:property value="#t.id" />">修改</a>
   	   	 	<a href="employer/support!supportByEmp.htm?action=delete&support.id=<s:property value="#t.id" />" onclick="javascript:confirm('确定删除该条信息?')">删除</a>
   	   	 </td>
   	   	 </tr>
   	   	</s:iterator>
		</tbody></table>
