...
<FORM action='admin/index!login.htm' method=post onsubmit="return check()">
...
<TABLE cellSpacing=0 cellPadding=0 width=1004 border=0>
            ...
            <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%" 
              ...
              <TR>
                ...
                <TD><INPUT class=regtxt title=请填写用户名 maxLength=16 size=16 
                  value="" name="username" id="username"></TD></TR>
              <TR>
                <TD align="center" width=81><FONT color=#ffffff>密&nbsp; 
                码：</FONT></TD>
                <TD><INPUT class=regtxt title=请填写密码 type=password maxLength=16 
                  size=16 value="" id="password" name=password></TD></TR>
              <TR>
              <!-- 
                <TD align="center" width=81><FONT color=#ffffff>角&nbsp; 
                色：</FONT></TD>
                <TD>
                </TD>
  ...
  <TR>
    ...
    width=24></TD>
    <TD><INPUT title='' type=image height=48 alt="" width=86 
