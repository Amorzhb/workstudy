...
<html>
    ...
    <tbody>
      <tr>
        <th align="center" colspan="12" style="height: 23px">综合素质管理</th>
      </tr>
      <tr bgcolor="#DEE5FA">
    	...
    	<tr bgcolor="#DEE5FA">
			 ...
			 <td align="center" class="txlrow"><s:if test="#t.ability==1">优秀</s:if><s:if test="#t.ability==2">良好</s:if><s:if test="#t.ability==3">差</s:if> </td>
	   	   	 ...
	   	   	 <td align="center" class="txlrow">
	   	   	  	<a href="admin/exercise!exerciseMsg.htm?exercise.id=<s:property value="#t.id" />">查看</a>
	   	   	 	<a href="admin/exercise!updateExercise.htm?exercise.id=<s:property value="#t.id" />">修改</a>
	   	   	 	<a href="admin/exercise!exerciseByEmp.htm?action=delete&exercise.id=<s:property value="#t.id" />" onclick="javascript:confirm('确定删除该条信息?')">删除</a>
	   	   	 </td>
   	   	 </tr>
   	   	 </s:iterator>
