    ...
    <tbody>
      ...
      <tr bgcolor="#DEE5FA">
    	...
    	<tr bgcolor="#DEE5FA">
   	   	 ...
   	   	 <a href="student/task!taskMsg.htm?task.id=<s:property value="#t.id" />">查看</a>
   	   	 <a href="javascript:" onclick="check('<s:property value="#t.id" />','${student.id }')">申请该职位</a>
   	   	 </td>
   	   	 </tr>
   	   	 </s:iterator>
   	   	 <tr bgcolor="#DEE5FA">
   	   	 <td  height="30px" align="right" class="txlrow" colspan="8">
   	   	 	...
   	   	 	&nbsp;&nbsp;&nbsp;
   	   	 	<a href="student/task!taskList.htm?currentPage=<s:property value="1" />">首页</a>
   	   	 	<a href="student/task!taskList.htm?currentPage=<s:property value="page.currentPage-1" />">上一页</a>
   	   	 	<a href="student/task!taskList.htm?currentPage=<s:property value="page.currnetPage+1" />">下一页</a>
   	   	 	<a href="student/task!taskList.htm?currentPage=<s:property value="page.totalPage" />">尾页</a>
   	   	 </td>
   	   	 </tr>
		</tbody></table>
		</div>
